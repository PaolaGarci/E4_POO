...
int main (){
    ...
    // Creando un empleado Sucursal 1: De Jose
    Empleado emp10("Jose","av. X",'M',33234565,"23/04/01","gerente","Vallarta");
    Empleado emp11("Jose","av. X",'M',33234565,"23/04/01","vendedor","Vallarta");
    Empleado emp12("Jose","av. X",'M',33234565,"23/04/01","administrador","Vallarta");
    ...
    // Creando un empleado Sucursal 2: DE JUAN
    Empleado emp1("Juan","av. X",'M',33234565,"23/04/01","gerente","NO Vallarta");
    Empleado emp2("Juan","av. X",'M',33234565,"23/04/01","vendedor","NO Vallarta");
    Empleado emp3("Juan","av. X",'M',33234565,"23/04/01","administrador","NO Vallarta");

    sucursal1.mostrarSucursal();
    
    // Creando tres clientes
    Cliente c1("Ivan","sss",'M',2333345,"01/01/02","A000000");
    Cliente c2("Alejandro","Av.Independencia",'F',33234324,"03/04/86","A000003");
